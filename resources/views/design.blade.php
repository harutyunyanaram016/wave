...
<div class="d-flex justify-content-around">
        ...
        <div id="contentWrapper">
            <ul>
                <li style="background-image: url('img/3d/1.jpg')"></li>
                <li style="background-image: url('img/3d/2.jpg')"></li>
                <li style="background-image: url('img/3d/3.jpg')"></li>
				<li style="background-image: url('img/3d/4.jpg')"></li>
				<li style="background-image: url('img/3d/5.jpg')"></li>
                <li style="background-image: url('img/3d/6.jpg')"></li>
                <li style="background-image: url('img/3d/7.jpg')"></li>
				<li style="background-image: url('img/3d/8.jpg')"></li>
				<li style="background-image: url('img/3d/9.jpg')"></li>
            </ul>
        </div>
		<div id="dark"></div>
		<div id="lightbox"></div>
